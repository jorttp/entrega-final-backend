...
public class ProductoPedidoDTO {
	...
	public ProductoPedidoDTO(final UUID id, final int cantidad, final ProductoDTO producto, final PedidoDTO pedido) {
		setId(id);
	...
	public ProductoPedidoDTO setCantidad(int cantidad) {
