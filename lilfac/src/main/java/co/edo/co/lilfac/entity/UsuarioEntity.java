...
public final class UsuarioEntity {
	...
	public UsuarioEntity (final int id, final String nombre, final String apellido, final int cedula, final int telefono, final String correo) {
		setId(id);
		setNombre(nombre);
	...
	public static UsuarioEntity obtenerValorDefecto(final UsuarioEntity usuario ) {
		return UtilObjeto.getInstance().obtenerValorDefecto(usuario, new UsuarioEntity());
	}
